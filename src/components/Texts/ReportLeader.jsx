...
const ReportLeader = () => {
    ...
    <Container maxWidth="xl">
        ...
        <LeaderReport title="Deepen Your Understanding" info="Read our eBook, Understanding Your Kingdom Calling Report, to learn how your Sphere of Influence, Biblical DNA, and Five-Fold Personality work together to shape your impact in the workplace and guide the ways you can serve within your local church." button={true} buttonText={"E-Book"} buttonLink="https://www.theriseupculture.com/course/understanding-your-kingdom-calling-pdf" cardColor="#D4AF37" titleColor="white" buttonColor="secondary"/>
        <LeaderReport title="Get Personal Support" info="Book a Calling Coach Session with The Rise Up Culture Team if you would like to walk through your results one-on-one and gain clarity on what obedience and faithfulness look like in this season." button={true} buttonText={"Book Now"} buttonLink="https://www.theriseupculture.com/course/kingdom-calling-coaching" cardColor="#D4AF37" titleColor="white" buttonColor="secondary"/>
