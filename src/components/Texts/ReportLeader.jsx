...
const ReportLeader = () => {
    ...
    <Container maxWidth="xl">
        ...
        <LeaderReport title="Get Personal Support" info="Book a Calling Coach Session with The Rise Up Culture Team if you would like to walk through your results one-on-one and gain clarity on what obedience and faithfulness look like in this season." button={true} buttonText={"Book a"} buttonLink="" cardColor="#D4AF37" titleColor="white" buttonColor="secondary"/>
