        ...
        <Container maxWidth="xl">
            <Box display={"flex"} justifyContent={"space-around"} sx={{padding:"40px 0px"}}>
                <Box>
                    ...
                    <Typography variant="subtitle1" fontWeight={"600"}>{reportInfo[0].keyUsed}</Typography>
                </Box>
                <Box>
                    <Typography variant="h4" fontWeight={"600"} color="yellow2.main">5-Fold Leaning</Typography>
                    <Typography variant="subtitle1" fontWeight={"600"}>{reportInfo[1].keyUsed}</Typography>
                </Box>
                <Box>
                    <Typography variant="h4" fontWeight={"600"} color="yellow3.main">Biblical DNA</Typography>
                    <Typography variant="subtitle1" fontWeight={"600"}>{reportInfo[2].keyUsed}</Typography>
                </Box>
            </Box>
        </Container>
    )
